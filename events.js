module.exports = {
    ...
    "respawn-gaming": {
        ...
        "events": [{
            ...
            "link": "",
            "rnr": ["An Augmented reality based treasure hunt.", "Various markers will be placed in many locations, students needs to scan the marker and and Augmented model will appear in front of them.", "This will guide them to further clues and finally it will lead them to the treasure.", "The student who finds the treasure first, needs to send a screen shot of the Augmented model to a number on whatsapp which will be monitored by the coordinators.", "Whoever sends the screenshot first is the winner."],
            "desc": "",
            ...
            "link": "",
            "rnr": ["Single player game.", "2 laps.", "Participants who complete the 2laps quickest wins.", "Judges decision is final."],
            "desc": "",
            "name": "Road Rash",
            "id": 55
        }, {
            ...
            "link": "",
            "rnr": ["An experience event.", "An opportunity for you to experience virtual reality."],
            "desc": "",
    ...
    "informal-events": {
        ...
        "events": [{
            ...
            "img": "",
            "contacts": [
                ["Mihika Mahajan", "9620854548"]
            ],
            "link": "",
            "rnr": ["The player must not spill any food.", "The player who finishes the food the fastest qualify to the next round.", "Round 1: This will be held with 10 participants contesting at a time. The fastest two will qualify to the next round.", "Round 2: From this stage, knockout rules will apply.", "Round 3: Final round"],
            "desc": "",
            "name": "Hogathon",
            "id": 70
        }, {
            ...
            "link": "",
            "rnr": ["Minimum of 4 contestants in each category or else the contestant will be put into the next category.", "Contests should carry valid ID card for verification.", "3 places will be awarded in each category.", "1st place winners of each category will compete for the title Mr. UTSAV."],
